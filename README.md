...
`tinycolor` can be installed from npm:
    ...
    npm install @hishprorg/fuga-sit-corrupti

Then it can be used in your script like so:

```js
var tinycolor = require("@hishprorg/fuga-sit-corrupti");
...
```js
import tinycolor from "@hishprorg/fuga-sit-corrupti";
var color = tinycolor("red");
```
...
It can be used as a module by downloading [npm/esm/tinycolor.js](https://github.com/hishprorg/fuga-sit-corrupti/blob/master/npm/esm/tinycolor.js) or using https://esm.sh/@hishprorg/fuga-sit-corrupti.

```html
<script type='module'>
import tinycolor from "https://esm.sh/@hishprorg/fuga-sit-corrupti";
var color = tinycolor("red");
</script>
```
...
You can use it directly in a script tag by downloading the UMD file from [npm/cjs/tinycolor.js](https://github.com/hishprorg/fuga-sit-corrupti/blob/master/npm/cjs/tinycolor.js):
...
```
See [index.html](https://github.com/hishprorg/fuga-sit-corrupti/blob/master/index.html) in the project for a demo.
